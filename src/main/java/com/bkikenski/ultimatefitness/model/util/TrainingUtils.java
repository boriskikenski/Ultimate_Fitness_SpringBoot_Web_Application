...
public class TrainingUtils {
    ...
    public static final List<MuscleGroup> PULL_DAY_MUSCLE_GROUPS = List.of(MuscleGroup.BACK, MuscleGroup.BICEPS,
            MuscleGroup.FOREARM, MuscleGroup.TRAPS, MuscleGroup.ABS);
